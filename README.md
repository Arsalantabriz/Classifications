...
The test.csv dataset contains similar information but does not disclose the “ground truth” for each passenger. the job is to predict these outcomes.

Using the patterns you find in the train.csv data, it is predicted whether the other 418 passengers on board (found in test.csv) survived.
